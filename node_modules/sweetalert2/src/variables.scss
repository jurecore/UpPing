...
$swal2-active-step-background: #82f65f !default;
...
$swal2-confirm-button-background-color: #2ef78f !default;
...
$swal2-loader-border-color: #82f65f transparent #2ef78f transparent !default;
